...
/**
 * Interface for the ServiceExampleLogger service that may be modified by 
 * developers to encapsulate any service operations that are not supported
 * for definition in this domain's meta-model.
 *
 * @see org.bitbucket.askllc.fermenter.cookbook.domain.service.rest.ServiceExampleLoggerBaseService
 * 
 * GENERATED STUB CODE - PLEASE *DO* MODIFY
 */
@Path(ServiceExampleLoggerService.PATH)
public interface ServiceExampleLoggerService extends ServiceExampleLoggerBaseService {

    /**
     * Path for this service. Path is used multiple places, so having it in a constant ensures they are all consistent.
     */
    public static final String PATH = "ServiceExampleLoggerService";
