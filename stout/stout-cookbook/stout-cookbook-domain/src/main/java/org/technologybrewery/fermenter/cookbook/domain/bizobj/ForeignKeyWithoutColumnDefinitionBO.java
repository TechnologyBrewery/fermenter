 ...
 * @see org.technologybrewery.fermenter.cookbook.domain.bizobj.ForeignKeyWithoutColumnDefinitionBaseBO
 *
...
public class ForeignKeyWithoutColumnDefinitionBO extends ForeignKeyWithoutColumnDefinitionBaseBO {
    ...
    /**
    * Lifecycle method that is invoked when saving ForeignKeyWithoutColumnDefinition via a creation or update, 
    * only if the entity's fields were validated successfully. 
    * 
    * If ForeignKeyWithoutColumnDefinition requires additional business logic in order to validate its data prior to saving, 
