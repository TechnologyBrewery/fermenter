...
/**
 * Implements the contract for a metamodel element that requires a package and
 * name.
 */
public abstract class NamespacedMetamodelElement extends MetamodelElement
	...
	/**
	 * Sets the packageName of the metadata element.
	 * 
	 * @param packageName namespace/package of the element
	 */
