package org.technologybrewery.fermenter.cookbook.local.referencing.domain.persist;

import java.util.UUID;

import org.technologybrewery.fermenter.cookbook.local.referencing.domain.bizobj.PlaceholderBO;
