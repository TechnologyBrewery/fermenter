...
public class TestDefaultMessageEquals extends AbstractMessagesTestCase {
	...
	public void testEquality2() {
		...
		Message message2 = createMessage(ERROR, key1, new String [] {property1});
	...
	public void testEquality5() {
		...
		Message message2 = createMessage(INFO, key1, new String [] {property1});
	...
	public void testInequality3() {
		Message message1 = createMessage(ERROR, key1, new String [] {property1});
		Message message2 = createMessage(ERROR, key1, new String [] {property3});
	...
	public void testInequality4() {
		Message message1 = createMessage(ERROR, key1, new String [] {property1, property3});
		Message message2 = createMessage(ERROR, key1, new String [] {property3, property2});
	...
	public void testInequality5() {
		Message message1 = createMessage(ERROR, key1, new String [] {property1, property3});
		Message message2 = createMessage(ERROR, key1, new String [] {property1, property3, property2});
	...
	public void testInequality6() {
		Message message1 = createMessage(ERROR, key1, new String [] {property3});
		Message message2 = createMessage(ERROR, key1, new String [] {});
