...
public class RelatedObjectiveCEntity extends ObjectiveCEntity {

	private Entity entity;
	private Entity parentEntity;
	private Map decoratedIdFieldMap;

	public RelatedObjectiveCEntity(Entity entity, Entity parentEntity) {
		super(entity);
	...
	class SelfReferenceField extends ObjectiveCField {
		 ...
		 * @see org.bitbucket.fermenter.cider.mda.element.objectivec.ObjectiveCField#getColumn()
		 */
		@Override
