package org.bitbucket.fermenter.util;
...
public final class ResourceBundleResolver {
	 ...
	 * named com.foo.bar.<<bundle name>>, com.foo.<<bundle name>>, com.<<bundle name>>,
	...
	private ResourceBundle findBundle(String namespace, Locale locale) {
		...
		throw new MissingResourceException("Unable to fund resource bundle for namespace " + namespace + " and Locale " + locale, null, null);
	}
