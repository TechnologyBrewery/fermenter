...
Scenario Outline: Non-persistent entity can have an external reference to a persistent entity
  ...
  Scenario Outline: Non-persistent entity can have an external reference to a non-persistent entity
    Given a transient entity "<schoolBuilding>"
 ...
 Scenario Outline: Persistent entity can have an external reference to a non-persistent entity   
    Given a persistent entity "<building>"
    And a transient entity "<postalDistrict>" in another domain
    When references are added
    Then the entity "<building>" can have a reference "<postalDistrict>"
  ...
  Scenario Outline: Non-persistent entity reference level validation passes on valid persistent entity references
  ...
  Scenario Outline: Non-persistent entity reference level validation fails on invalid peristent entity references
   ...
   Scenario Outline: Non-persistent entity reference level validation passes on valid transient entity references
  ...
  Scenario Outline: Non-persistent entity reference level validation fails on invalid transient entity references
  ...
  Scenario Outline: Persistent entity reference level validation passes on valid transient entity references
    ...
    When the reference level validation is performed on the instance "<building>"
    Then the reference level validation passes
