package org.tigris.atlas.mda.objectivec;
...
/**
 * Responsible for maintaining mappings from logical type names to Objective-C types.
 */
public class ObjectiveCTypeManager {

	private Map<String, String>  typeMap = new HashMap<String, String>();
	private EntityResolver resolver;
	private static Log log = LogFactory.getLog(ObjectiveCTypeManager.class);
	...
	private ObjectiveCTypeManager() {
		// Create the entity resolver to ensure proper DTD resolution regardless of whether or not the system id specified in an xml file is valid
	...
	private Digester getNewDigester(EntityResolver resolver, File fileToParse, LoggingErrorHandler errorHandler) {
		// Digester's documentation specifically suggests that a new instance should be created even though Digester has a clear() method
