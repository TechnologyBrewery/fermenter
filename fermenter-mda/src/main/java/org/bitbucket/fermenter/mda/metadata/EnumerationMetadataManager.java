...
import org.bitbucket.fermenter.mda.metadata.element.EnumMetadata;
import org.bitbucket.fermenter.mda.metadata.element.Enumeration;
import org.bitbucket.fermenter.mda.metadata.element.EnumerationMetadata;
...
class EnumerationMetadataManager extends MetadataManager {
    ...
    private static final Log LOGGER = LogFactory.getLog(EnumerationMetadataManager.class);
    ...
    /**
     * Answer the full collection of enumeration metadata entries, regardless of
     * source application.
     * 
     * @return
     */
     ...
     * 
     * @param digester
     *            Used to parse the metadata file into metadata elements
     */
