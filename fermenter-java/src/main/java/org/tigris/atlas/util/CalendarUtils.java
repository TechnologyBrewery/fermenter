...
public final class CalendarUtils {
	...
	private static Map  DAYS   = null;
	private static List YEARS  = null;
	private static List YEARS_WITH_FUTURE  = null;
	private static Map  HOURS  = null;
	private static Map  MINUTES= null;
	...
	public static Timestamp getTimestamp(String month, String day, String year, String hours, String minutes) {
    ...
    */
	...
	public static List getFutureYears() {
		if( YEARS_WITH_FUTURE == null ) {
			YEARS_WITH_FUTURE = new ArrayList();
