...
public class StoutAttributeProvider extends BaseNamedAttributeProvider {
    ...
    private Cache<String, Collection<org.technologybrewery.fermenter.stout.authz.AttributeValue<?>>> attributeCache;
    ...
    public <AV extends AttributeValue> AttributeBag<AV> get(final AttributeFqn attributeGUID,
        ...
        Collection<org.technologybrewery.fermenter.stout.authz.AttributeValue<?>> retrievedValues = getStoutAttributeByIdAndSubject(
                id, subject);
        if (retrievedValues != null) {
            for (org.technologybrewery.fermenter.stout.authz.AttributeValue<?> retrievedValue : retrievedValues) {
     ...
     */
    public Collection<org.technologybrewery.fermenter.stout.authz.AttributeValue<?>> getStoutAttributeByIdAndSubject(String id,
                                                                                                                     String subject) {

        StringBuilder builder = new StringBuilder();
        String cacheKey = builder.append(subject).append(':').append(id).toString();

        Collection<org.technologybrewery.fermenter.stout.authz.AttributeValue<?>> retrievedValues;
    ...
    protected <AV extends AttributeValue> SimpleValue<?> convertRetrievedValueToXacmlFormat(
            ...
            org.technologybrewery.fermenter.stout.authz.AttributeValue<?> retrievedValue) {
