...
public abstract class AbstractDefaultMessages implements Messages {

    private static final long serialVersionUID = 8768896128249802175L;

    // TODO: replace this with two sets, one for errors, one for infos for
    // simplicity:
     ...
     */
    public AbstractDefaultMessages() {
        super();
