...
/**
 * Interface for the BeerServiceExample service that may be modified by 
 * developers to encapsulate any service operations that are not supported
 * for definition in this domain's meta-model.
 *
 * @see org.technologybrewery.fermenter.cookbook.domain.service.rest.BeerServiceExampleBaseService
 * 
 * GENERATED STUB CODE - PLEASE *DO* MODIFY
 */
@Path(BeerServiceExampleService.PATH)
public interface BeerServiceExampleService extends BeerServiceExampleBaseService {

    /**
     * Path for this service. Path is used multiple places, so having it in a constant ensures they are all consistent.
     */
    public static final String PATH = "BeerServiceExampleService";
