 ...
 * @see org.technologybrewery.fermenter.cookbook.domain.bizobj.ValidationReferenceExampleBaseBO
 *
...
public class ValidationReferenceExampleBO extends ValidationReferenceExampleBaseBO {
    ...
    /**
    * Lifecycle method that is invoked when saving ValidationReferenceExample via a creation or update, 
    * only if the entity's fields were validated successfully. 
    * 
    * If ValidationReferenceExample requires additional business logic in order to validate its data prior to saving, 
